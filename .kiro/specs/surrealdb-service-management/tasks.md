...
- [ ] 2. 实现日志服务
  - [ ] 2.1 创建 LoggerService 基于 electron-log
...
- [ ] 10. 实现 SurrealDB 核心服务
  - [ ] 10.1 创建 SurrealDBService 类基础结构
...
- [ ] 11. 创建模块导出
  - [ ] 11.1 创建 surrealdb-service 模块导出
    - 创建 `src/main/services/surrealdb-service/index.ts`
    - 导出 SurrealDBService
    - 导出类型定义
    - _需求: 9.1_
  - [ ] 11.2 更新 services 总导出
...
- [ ] 13. 集成到 AppService
  - [ ] 13.1 修改 AppService 集成 SurrealDB
